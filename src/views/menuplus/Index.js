...
const Index = () => {
	...
	useEffect(()=>{
		window.document.getElementsByTagName("html")[0].classList.add("rending");
	...
	return (
		<section>
			...
			<article className="item1">
				<img src={"https://event.thecheck.co.kr/img/menuplus/rending/img1.jpg"} alt="돈쭐나고 싶으세요? 인생맛집 5분창업 #샵인샵 #업종변경 #창업 #사업확장 #배달전문 #신메뉴추가 메뉴플러스"/>
			</article>
			<article className="item2">
				<img src={"https://event.thecheck.co.kr/img/menuplus/rending/img2.jpg"} alt="자영업자 필수 플랫폼 더체크가 사업장을 맛집으로 만들어드리겠습니다"/>
			</article>
			<article className="item3">
				<img src={"https://event.thecheck.co.kr/img/menuplus/rending/img3.jpg"} alt="아래 하나라도 해당하면 지금 메뉴플러스를 만날 때! 신메뉴가 필요한 사장님, 업종 변경이 시급한 사장님, 배달음식 사업하는 사장님, 샵인샵 창업을 생각하는 사장님 메뉴플러스의 검증된 상품으로 사업장 매출 확! 올려보세요"/>
			</article>
			<article className="item4">
				<img src={"https://event.thecheck.co.kr/img/menuplus/rending/img4_1.jpg"} alt="메뉴플러스란? 불필요한 비용, 거품 ZERO 더체크가 만든 간편조리식품 식자재몰로 검증된 상품을 최저가에 제공합니다"/>
			</article>
			<article className="item5">
				<img src={"https://event.thecheck.co.kr/img/menuplus/rending/img5_1.jpg"} alt="메뉴플러스 이용 특전 - 회원 전용, 최저가 상품, 빠른 물류 배송, 배달 등록 자료 무료 제공, 매니저 컨설팅 무료"/>
			</article>
